...
//    NSString* _dir = [self baseRecordPathWithURL:url];
    NSString * _dir = [self documentsDirectory];
...
//    }
    ...
    NSString *p = [NSString stringWithFormat:@"%@_%@.mp4", [self baseURLWithURL:url], [formatter stringFromDate:date]];
    NSString *path = [_dir stringByAppendingPathComponent:p];
