...
- (void) setItemView {
    ...
    _label.textColor = LQColor(108, 108, 108);
    ...
    _operationBtn.backgroundColor = UIColorFromRGB(LQThemeColor);
    [_operationBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    _operationBtn.titleLabel.font = [UIFont systemFontOfSize:LQTextFont];
    LQViewBorderRadius(_operationBtn, 5, 0, [UIColor clearColor]);
    ...
    [_operationBtn makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo(LQScreenWidth - 100);
